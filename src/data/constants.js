  ...
  export const experiences = [
    {
      ...
      desc: [
        "Achieved $300/week reduction in inventory costs by creating time series forecast using ARIMA machine learning model in Python to predict inventory, sales, and shipment.",
      ],
      skills: [
        "Python",
        "Machine Learning",
    ...
    },
    {
      ...
      desc: [
        "Designed web applications and engineered REST and SOAP APIs, handling JSON, XML data along with JQuery, OAuth for security in Apex, JavaScript and SQL, reducing paperwork by 75%, benefiting user base of 1M+.",
        "Enhanced data processing efficiency by 30% and improved user experience through web and mobile application.",
        "Achieved Rs.10k savings by diagnosing, debugging, optimizing issues and developed solutions in Agile.",
        "Reduced deployment time by 15% in CI/CD pipelines by improving code coverage to 95%.",
        "Contributed 10K+ lines of code to an established code base for 5-6 end to end projects in real estate, financial and transportation sector.",
        "Leveraged SQL for data processing and enhanced user experience by integrating concise insights with D3.js, Tableau, custom reports and dashboards.",
      ],
      skills: [
        "Apex",
        "JavaScript",
    ...
    },
    {
      ...
      desc: [
        "Revamped client management database using indexing and better search queries in SQL enhancing performance by 20% and reducing query response time by 50ms.",
      ],
      skills: [
        "SQL",
        "Database Management",
    ...
    },
    {
      ...
      desc: [
        "Reduced noise levels in audio files by 20% by incorporating power spectral density and zero cut off noise reduction techniques over frames of audio file in Python. Achieved 10% compression in file while maintaining audio quality.",
      ],
      skills: [
        "Python",
        "Signal Processing",
